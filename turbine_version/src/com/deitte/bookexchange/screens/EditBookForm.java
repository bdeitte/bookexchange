...
public class EditBookForm extends Screen
{
    public ConcreteElement build( RunData data ) throws Exception
    {
        ...
        {
        	data.setMessage( "You must login before you edit a book!");
        ...
        data.setTitle("edit book");

        Form form = new Form ( 
            new DynamicURI ( data, "EditBookForm", "EditBook", true ).toString()
            , Form.POST );
...
/*		form.addElement("Title ");
        ...
        form.addElement ( 
            new Input ( Input.text, "isbn", 
                data.getParameters().getString("isbn", ""))
        ...
        form.addElement ( 
            new Input ( Input.text, "price", 
                data.getParameters().getString("price", ""))
                .setSize(25).setMaxlength(35));
